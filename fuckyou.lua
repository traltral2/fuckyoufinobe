        ...
        function Library:Keybind(properties) 
            ...
            local Items = Cfg.Items; do 
                ...
                -- Mode holder
                    ...
                    Section:Toggle({Name = "Show on list", Flag = Cfg.Flag .. "_LIST"})
                --
            end 
        ...
        function Library:Configs(Window, Tab)
            -- Settings
                ...
                Section:Button({Name = "Join New Server", Callback = function()
                    ...
                    if data.playing <= Flag["MaxPlayers"] then 
            ...
            -- Theming 
                ...
                Section:Dropdown({Name = "Font", Options = {"Verdana", "ProggyClean", "ProggyTiny", "Tahoma", "Minecraftia", "SmallestPixel"}, Callback = function(option)
                    for _,text in themes.utility.text_color.TextColor3 do 
                        text.FontFace = Fonts[option]
                    end 
                end, Default = "ProggyClean"})
        ...
        function Library:AddTab(properties)
            ...
            local Math = {}; do 
                ...
                function Math:Solve(model, viewportFrame, Camera)
                    ...
                    return UDim2.fromScale(relativePos.X * 200, relativePos.Y * 200), UDim2.fromScale(relativeSize.X * 220, relativeSize.Y * 200)
                end
                ...
                local Elements = Config.Items; do -- Useless ahh
                    ...
                    -- Text Section
                        ...
                        Elements.Options.Text = Label:Colorpicker({Callback = function(value)
                            ...
                            Elements.Name.TextTransparency = Flags[Config.Flag .. "_COLOR1"].Transparency
                ...
                local Elements = Config.Items; do -- Useless ahh
                    -- Esp Preview
                        ...
                        Elements.Gradient = Library:Create( "UIGradient" , {
                            Rotation = 45;
                            Name = "\0";
                            Color = rgbseq{rgbkey(0, rgb(255, 255, 255)), rgbkey(1, rgb(255, 0, 0))};
                    ...
                    -- Box Section
                        ...
                        Elements.Options.Low = Section:Label({ Name = "Low" }):Colorpicker({
                            Flag = Config.Flag .. "_GRADIENT_COLOR1",
                            Default = props.Color1 or rgb(255, 255, 255),
                            Callback = function()
                        ...
                        Elements.Options.Slider = Section:Slider({
                            Name = "Gradient Rotation", 
                            Min = 0, 
                            Max = 360, 
                            Decimals = 1, 
                            Flag = Config.Flag .. "_GRADIENT_ROTATION",
                            Default = props.Rotation or 0,
                        ...
                        -- Elements.Options.High = Section:Label({Name = "High"}):Colorpicker({Callback = function()
                        --     Elements.BarGradient.Color = rgbseq{rgbkey(0, Flags[Config.Flag .. "_COLOR1"].Color), rgbkey(0.5, Flags[Config.Flag .. "_COLOR2"].Color), rgbkey(1, Flags[Config.Flag .. "_COLOR3"].Color)}
                        -- end, Flag = Config.Flag .. "_COLOR3", Default = Elements.BarGradient.Color.Keypoints[3]})

                        -- Section:Toggle({Name = "Show Number"})
                        -- Section:Toggle({Name = "Enable Animations", Flag = Config.Flag .. "_LIST"})
                        -- Elements.Options.Mode = Section:Dropdown({Name = "Mode", Options = {"Linear", "Sine", "Back", "Bounce", "Circular", "Cubic", "Elastic", "Exponential", "Quad", "Quart", "Quint"}, Default = "Sine"})
                        -- Elements.Options.Direction = Section:Dropdown({Name = "Direction", Options = {"In", "Out", "InOut"}, Default = "InOut"})
...
-- Main holder for each panel, (buttons on the top right)
local Holder = Library:Window({Name = "finobeware.xyz"})
...
-- Main documentation
    ...
    aimlock:Keybind({Name = "Keybind", Mode = "Always"}) 
    ...
    -- mods:Toggle({Name = "Magic Bullet"})
    -- mods:Toggle({Name = "Instant Aim"})
    -- mods:Toggle({Name = "Instant Reload"})
    -- mods:Toggle({Name = "Instant Equip"})
    -- mods:Toggle({Name = "Silent Aim"})
    -- mods:Toggle({Name = "Silent Shoot"})
    -- mods:Toggle({Name = "Silent Reload"})
    -- mods:Toggle({Name = "Silent Equip"})
    -- mods:Toggle({Name = "Remove Spread"})
    -- mods:Toggle({Name = "Remove Recoil"})
    -- mods:Toggle({Name = "Remove Occlusion"})
    -- mods:Toggle({Name = "Remove Tracer"})
    -- mods:Toggle({Name = "Remove Flash"})
    -- mods:Toggle({Name = "Auto Reload"})
    -- mods:Toggle({Name = "Unlock Firemodes"})
    -- mods:Toggle({Name = "Custom Firerate"})
...
-- Esp preview 
    ...
    local PlayersTab = EspPreview:AddTab({Name = "Players", Model = game.Players.LocalPlayer.Character});
    ...
    EspPreviewSection:Slider({Name = "Max Render Distance", Min = 0, Max = 10000, Default = 0})
...
for _,player in Players:GetPlayers() do 
    Esp.CreateObject(player, nil, PlayersTab)
end 
